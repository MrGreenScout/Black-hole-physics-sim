...
![Bending space time 1](./report/img/thumbnail.png)
...
I got github pages support working, now you can access the program from anywhere as simple as going to [this](https://mrgreenscout.github.io/Black-hole-physics-sim/) link.
...
![Bending space time 1](./report/img/bendning-space-1.png)

![Bending space time 2](./report/img/bendning-space-2.png)
...
To understand the math I have found some really good resources, the wikipedia page about the [Schwartzchild metric](https://en.wikipedia.org/wiki/Schwarzschild_geodesics#cite_ref-Schwarzschild_metric_3-0) had a really good outline how to model a photon orbiting a black hole using Runge-Kutta 4 for example.
